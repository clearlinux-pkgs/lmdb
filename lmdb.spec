...
Version  : 0.9.28
Release  : 19
URL      : https://github.com/LMDB/lmdb/archive/LMDB_0.9.28/lmdb-0.9.28.tar.gz
Source0  : https://github.com/LMDB/lmdb/archive/LMDB_0.9.28/lmdb-0.9.28.tar.gz
...
%prep
%setup -q -n lmdb-LMDB_0.9.28
cd %{_builddir}/lmdb-LMDB_0.9.28
%patch1 -p1
%patch2 -p1
%patch3 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1612997369
...
cp %{_builddir}/lmdb-LMDB_0.9.28/libraries/liblmdb/COPYRIGHT %{buildroot}/usr/share/package-licenses/lmdb/7578422c24f1c556f2a5884294bdf7a545a53a64
cp %{_builddir}/lmdb-LMDB_0.9.28/libraries/liblmdb/LICENSE %{buildroot}/usr/share/package-licenses/lmdb/bc06cbdf781c87d2df2fe385214f936d010dd2a2
pushd libraries/liblmdb/
%make_install
popd
